...
class Train_val_test_split():
    def __init__(self, df_dummy, val_portion=0.25, last_year=2021):
        self.df1 = df_dummy
    ...
    def Train_val_test_split(self):
        ...
        #sampling_strategy_dict = {'increased': 3998, "constant": 3998, "decreased": 3998}
...
class Classification_Model():
    ...
    def Classification(self):
        ...
        return Overall_accuracy, Result_Bund, self.y_valid
